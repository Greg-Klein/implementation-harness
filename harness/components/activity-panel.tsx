...
import { RsiReviewPanel } from "./rsi-review-panel";
...
export function ActivityPanel({ run, onFeedback, onAnswer, onRsiApprove, onRsiReject }: { run: RunState; onFeedback: (body: string) => void; onAnswer: (answers: Record<string, string>) => void; onRsiApprove: (worktreeName: string) => void; onRsiReject: (worktreeName: string) => void }) {
