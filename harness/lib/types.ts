...
export type RunState = {
  ...
  startedAt: string | null; endedAt: string | null; agents: Agent[]; activities: Activity[]; artifacts: string[]; pendingQuestion?: PendingQuestion; pendingRsiReview?: PendingRsiReview; error?: string;
};
